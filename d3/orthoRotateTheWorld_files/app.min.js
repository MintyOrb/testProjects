...
function() {
    ...
    d3.selectAll("#map, #eisenlohr").data([n(a, o).scale(245).translate([a / 2, .56 * o]), d3.geo.eisenlohr().precision(.1).clipExtent([
        ...
        }(), d3.json("../../data/world-110m2.json", function(t, n) {
            d3.selectAll("svg").insert("path", ".foreground").datum(topojson.feature(n, n.objects.land)).attr("class", "land"), d3.selectAll("svg").insert("path", ".foreground").datum(topojson.mesh(n, n.objects.countries)).attr("class", "mesh"), r.world()
        })
}();